# working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay
...
```bash
sudo cinc-auditor exec https://github.com/mitre/working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay/archive/main.tar.gz --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
mkdir profiles
cd profiles
git clone https://github.com/mitre/working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay.git
cinc-auditor archive working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay
...
```
cd working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay
git pull
cd ..
cinc-auditor archive working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay --overwrite
sudo cinc-auditor exec <name of generated archive> --input-file <path_to_your_input_file/name_of_your_input_file.yml> --reporter json:<path_to_your_output_file/name_of_your_output_file.json> 
```
...
To report a bug or feature request, please open an [issue](https://github.com/mitre/working-cms-ars-5.0-red-hat-enterprise-linux-7-stig-overlay/issues/new).
